	...
	save: ( { attributes } ) => {
		...
		return (
			<div { ...blockProps }>
				...
				<div
					className="wp-block-mbs-blob-container-block__clip"
					style={ {
						clipPath: `url(#${ clipId })`,
						aspectRatio: `${ blobs[ blobType ].aspectRatio }`,
					} }
				>
